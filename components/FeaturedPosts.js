...
const FeaturedPosts = ({data}) => {
 ...
 [data]);
  ...
  const customLeftArrow = (
    <div className="absolute inline arrow-btn left-0 text-center py-3 cursor-pointer bg-pink-600 rounded-full">
  ...
  const customRightArrow = (
    <div className="absolute inline arrow-btn right-0 text-center py-3 cursor-pointer bg-pink-600 rounded-full">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6  text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
